...
class TrainPipeline:
    ...
    def start_data_ingestion(self)->DataIngestionArtifact:
        try:
            ...
            data_ingestion_artifact=data_ingestion.initiate_data_ingestion() #it will give us dataingestion artifact

            logging.info(f"data ingestion completedand artifact:{data_ingestion_artifact}")
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact)->DataValidationArtifact:
        try:
            ...
            data_validation=DataValidation(data_ingestion_arifact=data_ingestion_artifact,data_validation_config=data_validation_config)
